...
function RVBInspectionRequest_Event.new(vehicle, farmId, plusDuration)
...
function RVBInspectionRequest_Event:run(connection)
    ...
    --end
	if self.vehicle ~= nil and self.vehicle:getIsSynchronized() then
		self.vehicle:startInspection(self.farmId, self.plusDuration)
